...
| 对大纲不满意，想重新生成 | plan_outline | `advance_step(step_id='plan_outline', user_input=<说明>)` |
| 想重写初稿 | write_draft | `advance_step(step_id='write_draft', user_input=<说明>)` |
| 想重新审阅 | review_draft | `advance_step(step_id='review_draft', user_input=<说明>)` |
